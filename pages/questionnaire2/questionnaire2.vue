<template>
	<view class="content">
		<uni-forms>
			<qiun-title-bar title="感知压力量表" /><text class="example-info">这个量表中的问题询问的是你<b>上个月</b>的感受和想法。在每一种情况下，你都会被要求指出你对某一特定方式的感觉或想法的频率，你应该把每一个问题作为一个单独的问题来对待。最好的方法是相当快地回答每个问题。也就是说，不要试图计算出 你对某一特定方式的感受次数，而要指出似乎是合理估计的另一种方式。对于每个问题，请从以下选项中选择:</text>
